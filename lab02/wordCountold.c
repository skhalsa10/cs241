...
main()
{
  int c, numOfChars, numOfLines, numOfWordsTotal, isNewLine, inWord;
  int numOfWords, numOfCharsTotal;
  numOfChars = numOfLines = numOfCharsTotal = 0;
